...
public final class Cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if( s!= null){
      ...
      out.write("        var $qty=$(this).closest('p').find('.qty');\n");
      out.write("        var currentVal = parseInt($qty.val());\n");
      out.write("        if (!isNaN(currentVal)) {\n");
      out.write("            $qty.val(currentVal + 1);\n");
      out.write("        }\n");
      out.write("    });\n");
      ...
      out.write("        var qty = document.getElementsByName(\"Qty\")[0].value;\n");
      out.write("        var f1 = document.form2;\n");
      out.write("        f1.method=\"post\";\n");
      out.write("        f1.action='http://localhost:8080/LanvinF/UpdateCart?Id='+Id+\"&qty=\"+qty;\n");
      out.write("        f1.submit();\n");
      out.write("    }\n");
      out.write("\n");
      out.write("</script>\n");
