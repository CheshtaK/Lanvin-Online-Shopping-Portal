...
public final class IndianK_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
                ...
                try
                {
                    ...
                    rs = st.executeQuery("select * from Kids where Category='Indian'");
                while(rs.next())
                {
