...
public final class RegistrationPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form action=\"http://localhost:8080/LanvinF/ValidationServlet\" method=\"post\">\n");
      out.write("\t<div class=\"heading\" style=\"font-size:35px;weight:bold;font-family:Garamond;color:mediumvioletred\">Signup with Lanvin</div>\n");
      out.write("\t<input id=\"FirstName\" type=\"text\" name=\"fname\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" First Name\" autofocus required>\n");
      out.write("\t<input id=\"LastName\" type=\"text\" name=\"lname\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" Last Name\" required>\n");
      out.write("\t<input id=\"MobileNumber\" type=\"number\" name=\"mobile\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" Mobile Number\" maxlength=\"10\" pattern=\"[0-9]{10}\" required>\n");
      out.write("\t<input id=\"EmailAddress\" type=\"email\" name=\"email\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" Email Address\" required>\n");
      out.write("\t<input id=\"Gender\" type=\"text\" name=\"gender\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" Gender\">\n");
      out.write("\t<input id=\"Username\" type=\"text\" name=\"uname\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" UserName\" required>\n");
      out.write("\t<input id=\"Password\" type=\"password\" name=\"password\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" Password\" required pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{6,}\" title=\"The password must be 6 digit long and should contain atleast one number,one lowercase and one uppercase letter \">\n");
      out.write("\t<input id=\"ConfirmPassword\" type=\"password\" name=\"cpassword\" style=\"font-size:15px;font-family:Bookman\" placeholder=\" Confirm Password\" required>\n");
      out.write("\t<input id=\"RegisterButton\" type=\"submit\" style=\"font-size:15px;font-family:Arial Black;color:white\" value=\"REGISTER\">\n");
      out.write("\t<font id=\"Already\" style=\"font-size:14px\">Already have an account?</font>\n");
      out.write("\t<a href=\"http://localhost:8080/LanvinF/LoginServlet\" id=\"Already1\" style=\"font-size:14px;color:#ff3399\">Login!</a>\n");
      out.write("\t</form>\n");
      out.write("        </div>\n");
      out.write("    </body>\n");
      out.write("    <div>\n");
