...
public final class CasualShirts_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
                ...
                try
                {
                    ...
                    rs = st.executeQuery("select * from Men where Category='Casual Shirts'");
                while(rs.next())
                {
      ...
      out.write("\" alt=\"CasualShirt\" style=\"width:100%\">\n");
      out.write("                    <h1>");
      ...
      out.write("                f.action='http://localhost:8080/LanvinF/MenServlet?Id='+Id;\n");
      out.write("                f.submit();\n");
      out.write("            }\n");
      out.write("    </script>\n");
      out.write("</html>");
