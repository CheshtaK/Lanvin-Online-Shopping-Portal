...
public final class Jeans_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
                ...
                try
                {
                    ...
                    rs = st.executeQuery("select * from Women where Category='JJ'");
                while(rs.next())
                {
